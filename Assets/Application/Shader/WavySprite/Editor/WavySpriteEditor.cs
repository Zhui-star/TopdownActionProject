...
public class WavySpriteEditor:Editor{
	...
	public override void OnInspectorGUI(){
		...
		EditorGUILayout.BeginHorizontal();
		EditorGUILayout.PrefixLabel("Relevant material");
		Material relevantMaterial = (Material)EditorGUILayout.ObjectField(script.relevantShaderMat, typeof(Material), true);
		if(script.relevantShaderMat!=relevantMaterial)
        {
			Undo.RecordObject(script, "Relevant material");
			script.relevantShaderMat = relevantMaterial;
			EditorUtility.SetDirty(script);
        }
		EditorGUILayout.EndHorizontal();
