...
public class WavySprite:MonoBehaviour{
	...
	[SerializeField]
	[MoreMountains.Tools.MMInformation("when package relevant these shader",MMInformationAttribute.InformationType.Info,false)]
	public Material relevantShaderMat;
	[SerializeField]
