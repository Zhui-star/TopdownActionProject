...
Shader "LowPolyPackage/LowPolyWater" 
{
	Properties 
	{
		...
		_WaterPos("Water Position", Vector) = (0,0,0)
	...
	SubShader 
	{
    	...
    	Pass 
    	{
			...
			v2g vert(appdata_full v)
			{
				...
				v.vertex.x += _WaterPos.x;
				v.vertex.y += _WaterPos.y;
				v.vertex.z += _WaterPos.z;
			...
			{
				fixed4 c = float4(IN.specularColor + IN.diffuseColor, 1.0);
				c.a = _Color.a;
				return c;
