...
Shader "HTLibrary/Xray"
{
	...
	// 主颜色
	 [HDR]_GhostColor("Ghost Color", Color) = (0, 1, 0, 1)

		// x-ray 强度调整参数
		_Pow("Pow Factor", float) = 1

		_XRayPower("Color Power",Range(0.0001,10))=1
	}
		...
		SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutput o)
		{
			...
			float rim=1-dot(worldNormal,IN.viewDir);
			// 设置颜色
			o.Albedo = _GhostColor.rgb*pow(rim,1/_XRayPower);
