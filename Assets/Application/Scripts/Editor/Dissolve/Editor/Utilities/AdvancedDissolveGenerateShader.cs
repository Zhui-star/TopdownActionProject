...
namespace AmazingAssets.AdvancedDissolveEditor
{
    public class GenerateShader : Editor
    {
        ...
        static string GetCustomEditorName()
        {
            return "ShaderGraph.DefaultShaderGraphGUI";
        }
        ...
        static void AddCustomEditor(List<string> newShaderFile)
        {
            ...
            if (customEditroLineID != -1)
            {
                ...
                newShaderFile.Insert(customEditroLineID + 1, string.Format("    CustomEditor \"AmazingAssets.AdvancedDissolveEditor.{0}\"", GetCustomEditorName()));
            }
            ...
            else
            {
                ...
                for (int i = newShaderFile.Count - 1; i >= newShaderFile.Count - 10; i -= 1)
                {
                    ...
                    {
                        newShaderFile.Insert(i, string.Format("    CustomEditor \"AmazingAssets.AdvancedDissolveEditor.{0}\"", GetCustomEditorName()));
                        break;
                    }
                }
            }
        ...
        static bool AddShaderCode(List<string> newShaderFile)
        {
            ...
            if (Utilities.GetProjectRenderPipeline() == Utilities.RENDER_PIPELIN.BuiltIn)
                return false;
            ...
            if (Utilities.GetProjectRenderPipeline() == Utilities.RENDER_PIPELIN.Universal)
