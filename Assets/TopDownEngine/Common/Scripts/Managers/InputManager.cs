...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
		...
		//2020 2 8 skill 2
		public MMInput.IMButton Skill2Button { get; protected set; }

		protected string _mouseScrollWheel { get;private set; }

		public float PrimaryCameraZoom { get; private set; }

		public MMInput.IMButton TabButton { get; private set; }
		...
		protected virtual void InitializeButtons()
		{
			...
			ButtonList.Add(Skill1Button = new MMInput.IMButton(PlayerID, "UseSkill_1", Skill1ButtonDown, Skill1ButtonPressed, Skill1ButtonUp));
			ButtonList.Add(Skill2Button = new MMInput.IMButton(PlayerID, "UseSkill_2", Skill2ButtonDown, Skill2ButtonPressed, Skill2ButtonUp));
			ButtonList.Add(TabButton = new MMInput.IMButton(PlayerID, "Tab", TabButtonDown, TabButtonPressed, TabButtonUp));
        }
        ...
        protected virtual void InitializeAxis()
		{
			...
			_mouseScrollWheel = "Mouse ScrollWheel";
        }
		...
		{		
			...
			{	
				...
				SetCameraZoom();//2020 2 16  相机控制输入管理
			}									
		}

		void SetCameraZoom()
		{
			PrimaryCameraZoom = Input.GetAxis(_mouseScrollWheel);
		}
		...
		public virtual void Skill1ButtonDown() { Skill1Button.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void Skill1ButtonPressed() { Skill1Button.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
		public virtual void Skill1ButtonUp() { Skill1Button.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
		public virtual void Skill2ButtonDown() { Skill2Button.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void Skill2ButtonPressed() { Skill2Button.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
		public virtual void Skill2ButtonUp() { Skill2Button.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
		...
		public virtual void TabButtonUp() { TabButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
		public virtual void TabButtonDown() { TabButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void TabButtonPressed() { TabButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
    }
}