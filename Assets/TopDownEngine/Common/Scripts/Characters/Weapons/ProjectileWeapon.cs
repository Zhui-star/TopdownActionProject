...
{		
	...
	public class ProjectileWeapon : Weapon 
	{
        ...
        protected override float DelayBeforeUse 
        {
            get {
                ...
                return base.DelayBeforeUse* HTAttackSpeed.AnimSpeedPercent();
            }

            set => base.DelayBeforeUse = value; 
        }

        [Header("延迟孵化子弹")]
        public float delaySpawnProjectile = 0.3f;
        float DelaySpawnProjectile
        {
            get
            {
                if (HTAttackSpeed == null)
                ...
                return delaySpawnProjectile * HTAttackSpeed.AnimSpeedPercent();
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerator  IWeaponUse()
        {

            yield return new WaitForSeconds(DelaySpawnProjectile);
            ...
            if (ElementalistPassiveSkill._instance != null)
            {
                ElementalistPassiveSkill._instance.isNormalAttack = true;
            }
        }
