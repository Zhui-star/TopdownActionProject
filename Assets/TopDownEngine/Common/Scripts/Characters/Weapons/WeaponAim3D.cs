...
{	
	...
	public class WeaponAim3D : WeaponAim
    {
        ...
        //Limit some behaviour when attacking 
        private CharacterOrientation3D orientation3D;
        protected override void Initialization()
        {
            base.Initialization();
            _mainCamera = Camera.main;
            orientation3D=CharacterManager.Instance.GetCharacter("Player1").GetComponent<CharacterOrientation3D>();
        }
        ...
        protected override void LateUpdate()
        {
            ...
            if(!orientation3D.CharacterRotationAuthorized)return;
            GetCurrentAim();
