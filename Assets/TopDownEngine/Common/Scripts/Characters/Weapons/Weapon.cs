...
namespace MoreMountains.TopDownEngine
{
    ...
    public class Weapon : MonoBehaviour 
    {
        ...
        public enum TriggerModes { SemiAuto, Auto ,Accumlate}
        /// the possible states the weapon can be in
        public enum WeaponStates { WeaponIdle, WeaponStart, WeaponDelayBeforeUse, WeaponUse, 
            WeaponDelayBetweenUses, WeaponStop, WeaponReloadNeeded, WeaponReloadStart, WeaponReload, 
            WeaponReloadStop, WeaponInterrupted,WeaponAccumlate}
        ...
        public float delayBeforeUse = 0;
        protected virtual  float DelayBeforeUse
        {
            get
            {
                return delayBeforeUse;
            }
            set
            {
                delayBeforeUse = value;
            }
        }
        ...
        protected HTAttackSpeed HTAttackSpeed; //2020 216 
        public float InitialTimeBetweenUses = 0.3f;
        public float TimeBetweenUses
        {
            get
            {
                ...
                return HTAttackSpeed.AnimSpeedPercent() * InitialTimeBetweenUses;
            }
        }
        /// whether or not the time between uses can be interrupted by releasing the shoot button 
        /// (if true, releasing the button will cancel the time between uses)
        ...
        protected SkillReleaseTrigger skillReleaseTrigger;
        ...
        ///蓄力武器完成
        /// </summary>
        public bool AccumlateWeapon { get; set; }
        ...
        public virtual void Initialization()
        {
            ...
            HTAttackSpeed = GetComponent<HTAttackSpeed>();//2020 2 16
        ...
        public virtual void SetOwner(Character newOwner, CharacterHandleWeapon handleWeapon)
        {
            ...
            if (Owner != null)
            {
                ...
                _characterOrientation = Owner.GetComponent<CharacterOrientation3D>();
                skillReleaseTrigger=Owner.GetComponent<SkillReleaseTrigger>();
        ...
        public virtual void WeaponInputStart()
        {
            ...
            if (WeaponState.CurrentState == WeaponStates.WeaponIdle||WeaponState.CurrentState==WeaponStates.WeaponAccumlate)
            {
        ...
        protected virtual void TurnWeaponOn()
        {
            ...
            {
                _characterOrientation.RotationMode = CharacterOrientation3D.RotationModes.WeaponDirection;
            }
        ...
        public virtual void TurnWeaponOff()
        {
            ...
            MovementForbidden(false);
             ...
             _characterOrientation.RotationMode = CharacterOrientation3D.RotationModes.MovementDirection;        
        }
        ...
        /// <summary>
        /// Wheater forbidden movement when weapon using 
        /// </summary>
        /// <param name="forbidden">Is forbidden</param>
        protected virtual void MovementForbidden(bool forbidden)
        {
            if (PreventAllMovementWhileInUse && (_characterMovement != null)&&skillReleaseTrigger&&!skillReleaseTrigger.OnAttacking)
            {
                _characterMovement.MovementForbidden = forbidden;
            }
        }
