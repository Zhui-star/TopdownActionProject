...
namespace MoreMountains.TopDownEngine
{
    ...
    public class TopDownController3D : TopDownController
    {
        ...
        protected Vector3 _groundNormal = Vector3.one;
        ...
        public Vector3  _lastGroundPosition;
        ...
        public override void ResizeCollider(float newHeight)
        {
            ...
            _characterController.center = newYOffset * Vector3.up;
        ...
        protected override void CheckIfGrounded()
        {
            ...
            OverHole= Physics.SphereCast(ray, 1.0f, 1.0f, HoleLayerMask);
        ...
        /// 返回到最后一次地面的点
        /// </summary>
        public virtual void ResetToLastGroundNormal()
        {
            _transform.position= _lastGroundPosition;
        }
        ...
        public virtual void SetLastGoundPosition(Vector3 position)
        {
            _lastGroundPosition = _transform.position;
        }
        #endregion
