...
namespace MoreMountains.TopDownEngine
{
	...
	public class Character : MonoBehaviour
    {
        ...
        [Header("Character Identity Information Table")]
        [MMInformation("This is character properties reference",MMInformationAttribute.InformationType.Info,false)]
        public CharacterConfig characterTable;
        ...
        [Header("反馈")]
        public MMFeedbacks _initialFeedbacks;
        /// <summary>
		...
		{		
            ...
            _initialFeedbacks?.Initialization();
            _initialFeedbacks?.PlayFeedbacks();
		}
		...
		{
            CharacterManager.Instance.AddCharater(PlayerID, this);//添加角色管理
        ...
        protected virtual void OnDeath()
        {
            ...
            CharacterManager.Instance.RemoverCharacter(PlayerID);
