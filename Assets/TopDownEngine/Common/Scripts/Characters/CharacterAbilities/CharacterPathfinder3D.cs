...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterPathfinder3D : MonoBehaviour
    {
        ...
        //是否结束了寻路(可由其他变量控制)
        //private bool isOverPathfinder = false;
        //public bool IsOverPathFinder
        //{
        //    get
        //    {
        //        return isOverPathfinder;
        //    }
        //    set
        //    {
        //        isOverPathfinder = value;
        //    }
        //}
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsGetGoalPosition()
        {


            if(!(NextWaypointIndex + 1 < Waypoints.Length))
            {
                if(Waypoints.Length>=NextWaypointIndex+1&&NextWaypointIndex>=0)
                {
                    return Vector3.Distance(this.transform.position, Waypoints[NextWaypointIndex]) <= DistanceToWaypointThreshold;
                }
            }
