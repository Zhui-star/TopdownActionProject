...
namespace MoreMountains.Tools
{
    ...
    public class AIBrain : MonoBehaviour
    {
        ...
        {
            if(_gameManager.PlayingTimeline)
            {
                return;
            }
        ...
        protected AIState FindState(string stateName)
        {
            ...
            Debug.LogError("You're trying to transition to state '" + stateName + "' in " + 
                this.gameObject.name + 
                "'s AI Brain, but no state of this name exists. " +
                "Make sure your states are named properly, and that your transitions states match existing states.");
