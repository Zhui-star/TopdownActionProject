...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackFlicker : MMFeedback
    {
        ...
        protected override void CustomInitialization(GameObject owner)
        {
            ...
            {
                if (BoundRenderer.material.HasProperty("_MainColor"))
                {
                    _initialFlickerColor = BoundRenderer.material.GetColor("_MainColor");
                }
            }
        ...
        protected override void CustomReset()
        {
            ...
            if (Active && (BoundRenderer != null))
            {
                if (BoundRenderer.material.HasProperty("_MainColor"))
                {
                    ...
                    BoundRenderer.material.SetColor("_MainColor",_initialFlickerColor);
                }
            }
        }
        ...
        public virtual IEnumerator Flicker(Renderer renderer, Color initialColor, Color flickerColor, float flickerSpeed, float flickerDuration)
        {
            ...
            {
                renderer.material.SetColor("_MainColor", flickerColor);
                yield return new WaitForSeconds(flickerSpeed);
                renderer.material.SetColor("_MainColor", initialColor);
                yield return new WaitForSeconds(flickerSpeed);
            }
